...
class PrintDataset:
    ...
    def datasets_tests(self):
        ...
        text2kp = TextKeypointsDataset(
            path_to_numpy_file="/mnt/cephfs/How2Sign/npy_files/utterance_level/val/normalized_files/all_files_normalized.npy",
            path_to_csv="/mnt/gpid07/imatge/peter.muschick/workspace/own_model/data/text/4_linked_to_npy_raw/how2sign.val.id_transformed.txt_2npy.txt",
            path_to_vocab_file="/mnt/gpid07/imatge/peter.muschick/workspace/own_model/data/text/1_vocab_list/how2sign.val.id_vocab.txt",
            input_length=256,
            transform=ToTensor(),
            kp_max_len=0,
            text_max_len=0)
